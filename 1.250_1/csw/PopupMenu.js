...
export class PopupMenu{
    ...
    create(){
        let str = `<div class="field-filter">
            <div class="pop-menu-container">
                ...
                style="display: inline-flex;">
                    <span class="actions-button1">${this.label||'Filter'}: </span>
                </div>
                <label for="cars" class=" hide">${this.label||'Filter'}: </label>
        ...
        $('#'+this.uuid + ' .field-filter .actions-button1').on('click', (event)=>{
            this.open();
