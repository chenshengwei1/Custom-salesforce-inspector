        ...
        <div class="record-searchresult">
            ...
            <div class="flex-container">
                <div class="record-view-soql tabitem SOQL">
                    ...
                    <textarea readonly name="" id="record-message" style="height: 10px;font-size: large;" class="feedback-text feedback-input no-border"></textarea>
                </div>
