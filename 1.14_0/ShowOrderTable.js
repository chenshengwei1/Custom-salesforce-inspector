...
export class ShowOrderTable{
    ...
    addFieldFilter(container, sobjectname){
        ...
        $('#'+uuid + ' .field-filter .actions-button').on('click', (event)=>{
    ...
    createHead(){
        ...
        <p>
            Object Search:
            <input class="search" id="ordersearch" type="input" value="Order" autocomplete="off" style="width:80%"></input>
            <button class="tablinks" name="updateSelectObject" id="showOrderSearch">Refersh</button>
        </p>
        <p>
            ID: <input class="search" id="orderIdInput" type="input" value=""></input>
            Order Number: <input class="search" id="ordernumberInput" type="input" value=""></input>
            Order Name: <input class="search" id="ordernameInput" type="input" value=""></input>
        </p>
        <div class="showordersearchresult">
            ...
            <div id="showorderrealtionshiptable"></div>
        </div>`
