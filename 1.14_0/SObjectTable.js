...
export class SObjectTable extends Notifiable{
    ...
    render(){
        return `
            ...
            <h1>Relationship</h1>
            <table id="sobjectrelationshiptable">
                <thead>
                    <tr>
    ...
    createHead(){
        ...
        <p>
            ...
            <div>
                ...
                <input id="objectdetailsearch" class="search" type="input" value="Order" name="apiName" type="text" autocomplete="off"
                style="width:395px;height:30px;font-size:15pt;"></input>
                <button class="tablinks" name="updateSelectObject" id="refreshSelectObject">Refersh</button>
            </div>
    ...
    addEvents(treeroot){
        ...
        $('#select-sobject').on('change', ()=>{
            ...
            selectsjdata.innerHTML=`${this.tree.dataMap[opt]?.records?.map(e=>{
